    ...
    <div className="space-y-4">
        ...
        <div className="grid gap-3 sm:grid-cols-[1fr_auto]">
          ...
          <div className="flex items-end">
            <button
              ...
              disabled={signing || !form.secretKey?.trim()}
      ...
      <div>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Field label="merchant_code_partner">
            <input
              className="input font-mono text-xs"
      ...
      <div>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Field label="error_msg" className="sm:col-span-2">
            <input
              className="input font-mono text-xs"
              value={form.errorMsg}
      ...
      <div>
        <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-slate-500">customer_info</p>
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Field label="card_info.card_type">
          ...
          <Field label="card_info.card_number">
            <input
              className="input font-mono text-xs"
          ...
          <Field label="card_info.card_origin">
          ...
          <Field label="card_info.card_holder">
            <input
              className="input font-mono text-xs"
