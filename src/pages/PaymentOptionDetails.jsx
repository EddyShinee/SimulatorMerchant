...
export default function PaymentOptionDetails() {
  ...
  const handleFetchAll = async () => {
    ...
    try {
      ...
      recordStep('payment-option-details', 'success')
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <h1 className="page-title">🧾 {t('paymentOptionDetails.title')}</h1>
      </div>
      ...
      <div className="split-panel">
        ...
        <div className="space-y-5">
          ...
          <PaymentApiResultsPanel
            ...
            requestTitle={`📤 ${t('paymentOptionDetails.requestTitle')}`}
            responseTitle={`📥 ${t('paymentOptionDetails.responseTitle')}`}
